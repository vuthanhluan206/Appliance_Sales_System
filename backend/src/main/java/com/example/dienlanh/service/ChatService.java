        ...
        return chatClient.prompt()
                .system("""
                        ...
                        2. Các công cụ hỗ trợ bạn:
                           ...
                           - `searchGeneralKnowledge`: Gọi khi khách hàng hỏi về các thông tin chung khác như địa chỉ cửa hàng, giờ làm việc, chính sách bảo hành, phương thức thanh toán, giao hàng...
                        3. Hãy trả lời khách hàng một cách lịch sự, lễ phép (dạ, thưa, anh/chị, em) phù hợp với phong cách dịch vụ khách hàng chuyên nghiệp.
                        4. Nếu thông tin khách hàng yêu cầu không tìm thấy từ kết quả của các công cụ, hãy lịch sự thông báo cho khách hàng biết và đề xuất họ liên hệ hotline 0387551111 để được hỗ trợ chi tiết nhất.
                        """)
                .user(question)
